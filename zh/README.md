...
- **持續維護中**，會與每次 Claude Code 釋出保持同步（最新版本：v2.1.119，2026 年 4 月）
...
**它有人維護嗎？**
是的，而且持續維護。該指南會與每次 Claude Code 釋出同步。當前版本是 v2.1.119（2026 年 4 月），相容 Claude Code 2.1+。
...
可以。所有模板都適用於 Claude Sonnet 4.6、Claude Opus 4.7 和 Claude Haiku 4.5。Opus 4.7 在 v2.1.111 推出，新增 `xhigh` effort tier。
...
| **UI / Keyboard** | 主題、Vim、快捷鍵（v2.1.109+） | [13-ui-and-keyboard/README.md](13-ui-and-keyboard/README.md) |
| **Settings 與環境變數** | 完整參考（v2.1.119） | [10-cli/config-and-env-reference.md](10-cli/config-and-env-reference.md) |
